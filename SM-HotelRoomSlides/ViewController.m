...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [self createRoomView:[UIImage imageNamed:@"room10.png"] withType:@"Executive Suite" withPrice:@"900$"];
}

- (void)createRoomView:(UIImage*)image withType:(NSString*)type withPrice:(NSString*)price
{
